...
def kb_distance() -> str:
    return make_keyboard([
        [("🏖️ До 100м", {"a": "dist_0-100"})],
        [("🚶 150–500м", {"a": "dist_150-500"})],
        [("🚗 500–1000м", {"a": "dist_500-1000"})],
        [("🏙️ Более 1000м", {"a": "dist_1000-99999"})],
        [("➡️ Не важно", {"a": "dist_any"})],
        [("🔙 Назад", {"a": "go_start"})],
    ])
...
def process_action(user_id: int, peer_id: int, cmid: int, action: str):
    ...
    if action.startswith('loc_'):
        ...
        if location == 'должанская':
            ...
            kb = make_keyboard([
                [("🏠 1-комнатная", {"a": "type_1-комн"})],
                [("🏡 2-комнатная", {"a": "type_2-комн"})],
                [("🏘 3-комнатная", {"a": "type_3-комн"})],
                [("🏘️ Частный дом", {"a": "type_частный дом"})],
                [("🏨 Гостевой дом", {"a": "type_гостевой дом"})],
    ...
    # ── Выбор типа жилья ──
        ...
        kb = make_keyboard([
            [("👤 1–2 гостя", {"a": "guests_2"})],
            [("👥 3–4 гостя", {"a": "guests_4"})],
            [("👨‍👩‍👧‍👦 5–6 гостей", {"a": "guests_6"})],
            [("🏢 7+ гостей", {"a": "guests_7"})],
            [("➡️ Не важно", {"a": "guests_any"})],
            [("🔙 Назад", {"a": "go_start"})],
        ])
